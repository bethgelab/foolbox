...
def test_keras_theano_model(num_classes):
    print('Variable: ', os.environ['KERAS_BACKEND'])
...
@pytest.mark.parametrize('num_classes', [10, 1000])
def test_keras_theano_model_probs(num_classes):
    bounds = (0, 255)
    channels = num_classes
...
def test_keras_theano_model_preprocess():
    num_classes = 1000
    bounds = (0, 255)
    channels = num_classes
...
def test_keras_theano_model_gradients():
    num_classes = 1000
    bounds = (0, 255)
    channels = num_classes
