...
def test_keras_tensorflow_model(num_classes):
...
@pytest.mark.parametrize('num_classes', [10, 1000])
def test_keras_tensorflow_model_probs(num_classes):
    bounds = (0, 255)
    channels = num_classes
...
def test_keras_tensorflow_model_preprocess():
    num_classes = 1000
    bounds = (0, 255)
    channels = num_classes
...
def test_keras_tensorflow_model_gradients():
    num_classes = 1000
    bounds = (0, 255)
    channels = num_classes
