...
from foolbox.ext.native.attacks import LinearSearchBlendedUniformNoiseAttack


def test_linear_search_blended_uniform_noise_attack():
    channels = 3
    batch_size = 8
    h = w = 32
    bounds = (0, 1)
    ...
    attack = LinearSearchBlendedUniformNoiseAttack(fmodel)
    advs = attack(x, y)
