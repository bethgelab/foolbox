...
attacks: List[AttackTestTarget] = [
    ...
    AttackTestTarget(fa.NewtonFoolAttack(steps=20), uses_grad=True, requires_low_dimensional_input=True),
    AttackTestTarget(fa.VirtualAdversarialAttack(steps=50, xi=1), 10, uses_grad=True, requires_low_dimensional_input=True),
